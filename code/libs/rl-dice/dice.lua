...
local function getRollTotal(roll_result)
  local total = 0
  for _, number in ipairs(roll_result) do total = total + number end
  return total
end

function dice:rollAndTotal() return getRollTotal(dice.roll(self)) end
